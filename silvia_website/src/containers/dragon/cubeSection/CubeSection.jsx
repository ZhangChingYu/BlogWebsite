    ...
    return(
        <div className="dragon_cubeSection">
            ...
            <div className="dragon_cubeSection_cubes">
                <Cube Title={"App"} imgFile={appImg} Color={"#B8C2EF"} Weight={2} Top={"2rem"}/>
                <Cube Title={"Website"} imgFile={websiteImg} Color={"#CBFFE3"} Weight={3}/>
            </div>
            <div className="dragon_cubeSection_cubes">
                <Cube Title={"UI/UX"} imgFile={uiuxImg} Color={"#FFDBB0"} Weight={3}  Top={"2rem"}/>
                <Cube Title={"Notes"} imgFile={noteImg} Color={"#FFD3EE"} Weight={2} Top={"2rem"}/>
            </div>
        </div>
    )
}
